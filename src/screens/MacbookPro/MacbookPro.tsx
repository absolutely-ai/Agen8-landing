...
const MacbookPro = () => {
  ...
  return (
    <div className="bg-[#FFF4EB] min-h-screen relative z-0">
      ...
      {/* Hero Section */}
      <div className='mt-35 flex flex-col items-center justify-center w-[90%] sm:w-[80%] mx-auto z-10'>
        ...
        <h1 className='text-[56px] gap-y-4 leading-[1.05] text-center text-[#111] font-[Outfit]'>
        ...
        {/* Subtitle */}
        <p className="mt-6 text-[20px] sm:text-[20px] font-[Outfit] text-[#222] font-normal text-center max-w-[800px]">
          Stop managing prompts. Start running systems with agent that research, execute and deliver.
        </p>

        {/* Input Box */}
        <div className="mt-12 w-full max-w-[800px] relative">
          {/* Top Tab */}
